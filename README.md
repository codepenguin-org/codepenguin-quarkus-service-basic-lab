# codepenguin-quarkus-service-basic-lab Project
...
You can then execute your native executable with: `./target/codepenguin-quarkus-service-basic-lab-1.0-SNAPSHOT-runner`
